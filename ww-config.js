export default {
    editor: {
        ...
        customSettingsPropertiesOrder: [
            ...
            ["weeksAndMonthsTitle", "weekStart", "weekNumbers", "hideOffsetDates", "disableMonthYearSelect"],
    ...
    properties: {
        ...
        enableMultiCalendars: {
            ...
            defaultValue: false,
            hidden: (content) =>
                content.selectionMode !== "range" || !["datetime", "date", "week"].includes(content.dateMode),
        },
        multiCalendars: {
            label: {
                en: "Calendars number",
        ...
        lang: {
            ...
            type: "TextSelect",
            options: () => {
                const options = wwLib.wwWebsiteData.getCurrentPage().langs.map((lang) => ({
                    value: lang,
                    label: { en: lang },
                }));
        ...
        themeCellBorderRadius: generateThemeSizingConfig("Cell border radius", 4, 20, true),
        themePreviewFontSize: generateThemeSizingConfig("Preview font size", 13, 48, true),
        themeMenuMinWidth: generateThemeSizingConfig("Menu min width", 250, 300, true),
        ...
        themeHoverTextColor: generateThemeColorConfig("Hover Text Color", "#212121", true),
        themeHoverIconColor: generateThemeColorConfig("Hover Icon Color", "#959595", true),
        themeBorderColor: generateThemeColorConfig("Border Color", "#ddd", true),
        themeMenuBorderColor: generateThemeColorConfig("Menu Border Color", "#ddd", true),
        themeBorderHoverColor: generateThemeColorConfig("Border Hover Color", "#aaaeb7", true),
        themeScrollBarBackgroundColor: generateThemeColorConfig("Scrollbar background Color", "#f3f3f3", true),
        themeScrollBarColor: generateThemeColorConfig("Scrollbar Color", "#959595", true),
        themeSuccessColor: generateThemeColorConfig("Success Color", "#76d275", true),
        themeSuccessDisabledColor: generateThemeColorConfig("Success Disabled Color", "#a3d9b1", true),
        ...
        themeHighlightColor: generateThemeColorConfig("Highlight Color", "#1976d219", true),
        triggerZone: {
            hidden: true,
            defaultValue: [
                {
